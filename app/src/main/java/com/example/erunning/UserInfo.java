...
public class UserInfo {
    ...
    public UserInfo(String name, int birthyear, int birthmonth, int birthday,ArrayList<String> followerlist, ArrayList<String> followinglist,ArrayList<String> contents){
        this.name = name;
